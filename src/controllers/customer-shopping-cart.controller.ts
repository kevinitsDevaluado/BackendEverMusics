...
export class CustomerShoppingCartController {
  ...
  @get('/customers/{id}/shopping-carts', {
    responses: {
      '200': {
        description: 'Array of Customer has many ShoppingCart',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.customerRepository.shoppingCarts(id).find(filter);
  }
  ...
  async create(
    ...
    return this.customerRepository.shoppingCarts(id).create(shoppingCart);
  }
  ...
  async patch(
    ...
    return this.customerRepository.shoppingCarts(id).patch(shoppingCart, where);
  }
  ...
  async delete(
    ...
    return this.customerRepository.shoppingCarts(id).delete(where);
  }
}
